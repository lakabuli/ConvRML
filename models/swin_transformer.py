...
# Adapted from: https://github.com/SwinTransformer/Swin-Transformer-Semantic-Segmentation/blob/main/mmseg/models/backbones/swin_transformer.py 
# --------------------------------------------------------
...
class Decoder(nn.Module):
    def __init__(self, rec_channels, original_height, original_width, sum_encoder_embed_dims=1920):
...
class SwinRecon(nn.Module):
    def __init__(self, n_channels, img_size, patch_size, embed_dim, num_heads):
        ...
        self.decoder = Decoder(rec_channels=n_channels, original_height=img_size[0], original_width=img_size[1])
